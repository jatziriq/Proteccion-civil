...
CREATE TABLE miembros_brigadas (
  ...
  CONSTRAINT miembros_brigadas_ibfk_1 FOREIGN KEY (brigada_id) REFERENCES brigadas (id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

-- 🔥 NUEVO: columna facultad
ALTER TABLE miembros_brigadas 
ADD COLUMN facultad VARCHAR(255) NULL AFTER n_cuenta;
...
CREATE TABLE solicitudes_brigadistas (
  ...
  carrera varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  semestre int DEFAULT NULL,
  brigada_id int DEFAULT NULL,
  estatus enum('pendiente','aceptado','rechazado') COLLATE utf8mb4_unicode_ci DEFAULT 'pendiente',
...
-- NUEVO: columna facultad
ALTER TABLE solicitudes_brigadistas 
ADD COLUMN facultad VARCHAR(255) NULL AFTER n_cuenta;
...
CREATE TABLE usuarios (
  ...
  rol enum('admin','coordinador','usuario') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'usuario',
